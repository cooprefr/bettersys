    ...
    <div className="p-6 h-full overflow-y-auto">
      ...
      <div className="flex items-end justify-between mb-6 border-b border-grey/20 pb-4">
        <div>
          ...
          <div className="text-[10px] text-grey/80 tracking-widest mt-1">MANAGED PORTFOLIO // BASE NETWORK</div>
        </div>
        <div className="text-right">
          <div className="text-[10px] text-grey/80 tracking-widest mb-1">NET APY</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-surface border border-grey/10 p-4">
          <div className="text-[10px] text-grey/80 mb-2">TOTAL VALUE LOCKED</div>
          <div className="text-xl font-mono text-white">$1,245,890.00</div>
        </div>
        <div className="bg-surface border border-grey/10 p-4">
          <div className="text-[10px] text-grey/80 mb-2">24H PNL</div>
          <div className="text-xl font-mono text-better-blue">+$12,450.23</div>
        </div>
        <div className="bg-surface border border-grey/10 p-4">
          <div className="text-[10px] text-grey/80 mb-2">SHARE PRICE</div>
      ...
      <div className="bg-surface border border-grey/10 h-64 mb-6 flex items-center justify-center relative overflow-hidden">
        <div className="text-grey/70 font-mono text-sm">
          PERFORMANCE CHART
        </div>
      ...
      {/* Disclaimer */}
      <div className="mt-8 text-[10px] text-grey/70 text-center font-mono">
